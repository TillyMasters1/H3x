...
-- Copy Painting
local PaintFrame = game:GetService("Players").LocalPlayer.PlayerGui.MainGui.PaintFrame.GridHolder.Grid
local Pixels = {}

for _,v in ipairs(game:GetService("Workspace").Plots:GetChildren()) do
   if v.Name ~= "Unclaimed" then
       for _,v in ipairs(v.Easels:GetChildren()) do
          local Proximity = Instance.new("ProximityPrompt")  
          Proximity.ActionText = "Copy"
          Proximity.Parent = v.Canvas
          Proximity.Exclusivity = Enum.ProximityPromptExclusivity.OneGlobally
          Proximity.Triggered:Connect(function()
             local grid = v.Canvas.SurfaceGui.Grid
             for i = 1, 1024 do
                Pixels[i] = grid[i].BackgroundColor3
             end
          end)
       end
   end
...
PrintFrame.Parent = game:GetService("Players").LocalPlayer.PlayerGui.MainGui.PaintFrame
PrintFrame.BackgroundColor3 = Color3.fromRGB(210, 76, 71)
PrintFrame.BorderSizePixel = 0
PrintFrame.Position = UDim2.new(0.0116423732, 0, 0.741815627, 0)
PrintFrame.Size = UDim2.new(0.0734065473, 0, 0.0661204159, 0)
PrintFrame.ZIndex = 5

local UICorner = Instance.new("UICorner")
UICorner.CornerRadius = UDim.new(0, 22)
UICorner.Parent = PrintFrame

local Printer = Instance.new("ImageButton")
Printer.Name = "Printer"
Printer.Parent = PrintFrame
Printer.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Printer.BackgroundTransparency = 1.000
Printer.LayoutOrder = 1
Printer.Position = UDim2.new(0.193506494, 0, 0.105295934, 0)
Printer.Size = UDim2.new(0.806493282, 0, 0.789407015, 0)
Printer.ZIndex = 6
Printer.Image = "rbxassetid://3926307971"
Printer.ImageColor3 = Color3.fromRGB(154, 57, 54)
Printer.ImageRectOffset = Vector2.new(84, 404)
Printer.ImageRectSize = Vector2.new(36, 36)
Printer.ScaleType = Enum.ScaleType.Fit

local UIListLayout = Instance.new("UIListLayout")
UIListLayout.Parent = PrintFrame
...
PrintFrame.MouseEnter:Connect(function()
    Printer.ImageColor3 = Color3.fromRGB(255, 255, 255)
end)

PrintFrame.MouseLeave:Connect(function()
    Printer.ImageColor3 = Color3.fromRGB(154, 57, 54)
end)

Printer.MouseButton1Down:Connect(function()
    for i = 1, 1024 do
       PaintFrame[i].BackgroundColor3 = Pixels[i]
    end
end)
